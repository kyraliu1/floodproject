...
agzonal$proporion = agzonal$area/agarea

```
Overall, about 99.5% of the agricultural land in Yolo and Sacramento County is in a flood zone.  
Breaking that down, about 58.6% of agricultural land in the two counties is in high-risk flood zones, 38.3% is in moderate-risk flood zones, and about 2.6% is in a low-risk flood zone.  
...
urbzonal$proportion = urbzonal$area/urbarea

```
About 96.3% of the urban land in Yolo and Sacramento County is in a flood zone.  
Breaking that down, about 6.8% of urban land in the two counties is in high-risk flood zones, 84.7% is in moderate-risk flood zones, and about 4.9% is in a low-risk flood zone.  
