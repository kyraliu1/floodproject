...
knitr::kable(table(floodarea$FLD_ZONE),col.names = c("risk type","count"),
             caption= "Table 1. Initial Counts for Flood Zone Designations in Data")
initzones <- unique(floodarea$FLD_ZONE)
knitr::kable(table(landuse$SYMB_CLASS),col.names = c('crop mapping category','count'))
```
...
Then we used the following code to write data to shapefile for further visualization in ArcGIS pro
